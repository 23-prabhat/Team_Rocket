...
export const translations = {
  en: {
    ...
    analyze: {
      ...
      agreementList: "What you're agreeing to",
      clausesTitle: "Flagged Clauses",
      originalClause: "Original clause",
      noClauses: "No flagged clauses found in this document.",
      quizTitle: "Comprehension Check",
      quizPrompt: "Answer at least 2 of 3 questions correctly to unlock consent.",
      noQuiz: "No quiz questions generated.",
      submitAnswers: "Submit answers",
      tryAgain: "Try again",
      quizPass: "correct — you're ready to give consent.",
      quizFail: "correct — please review the document and try again.",
      consentTitle: "Give Consent",
      consentReady:
        "You've demonstrated understanding of this document. You may now confirm consent.",
      consentLocked: "Complete the comprehension check above to unlock this button.",
      consentRecorded: "Consent recorded",
      consentButton: "I Understand & Consent",
